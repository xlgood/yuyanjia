...
10. 【截止前不可揭晓】若卦题是“状态可能提前成立”类（如某产品是否已售罄、是否已发布、是否已破某值），直接返回 {"mode":"manual","provider":"","humanReadable":"该卦题结果可能在截止前提前揭晓，市场将失去悬念，禁止发布"}；只有具备固定官方揭晓时刻（发布会宣布、官方数据发布、比赛终场）的题才允许起草。`;
